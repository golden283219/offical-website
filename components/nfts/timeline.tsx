                ...
                <div>
                  <div className="flex">
                    ...
                    <div className="grow">
                      ...
                      {timelineStepData.map((item, index) => (
                        <div
                          className="flex flex-col sm:flex-row items-start text-primary text-40 pl-20 sm:px-50"
                          key={index}
                        >
                          <span className="w-full text-center sm:w-auto sm:mr-50 font-Future pt-40 sm:py-20">
                            {item.no}
                          </span>
                          <div className="grow w-full border-b border-gradient-dark py-20">
                            <div
                              className="flex items-center cursor-pointer"
                              onClick={() => openUnhold(index)}
                            >
                              <p className="grow font-Future">{item.name}</p>
                              <span>
                                <Icon
                                  className={
                                    opendUnholdIndex[index]
                            ...
                            <p
                              className={
                                'mt-20 text-20 leading-tight transition-all duration-200 ' +
                                (opendUnholdIndex[index] ? 'block' : 'hidden')
                              }
                            >
                              {item.content}
                            </p>
