    ...
    <div className="flex flex-col xl:flex-row py-40 px-15 sm:px-40 lg:p-100">
      <div className="xl:w-1/2 xl:pr-45 pb-50">
        ...
        <p className="mt-40 font-light leading-tight">
          ...
          Ethereum ushered
          {showReadMore ? ' in a golden age of decentralized technology; Defi, NFT, Tradfi, P2E and other future applications of smart contracts. We pay homage to this monumental milestone in humankind with EthClock, an NFT collection that leverages Ethereum\'s radical innovation to encapsulate its timelessness and programmability. Taking inspiration from the genesis block’s gas limit, EthClock is an NFT collection of 5000 perpetually redeemable and gamified wall clocks.' : '...'}
          <span onClick={() => setShowReadMore(!showReadMore)}
                className="cursor-pointer text-white-50">read {showReadMore ? 'less' : 'more'}</span>
        </p>
