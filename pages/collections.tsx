    ...
    <>
      ...
      <Layout>
        <div className="flex flex-col xl:flex-row" onClick={() => goToNfts}>
          <div className="min-w-400 bg-white-10">
            ...
            <div>
              ...
              <div className="mt-20 mx-40">
                <p className="text-white py-10 opacity-30 text-18 font-semibold"><span className="mr-20">+</span>...more
                  coming soon!</p>
              </div>
            </div>
          </div>
          ...
          <div onClick={() => goToNfts()}
               className="grow p-100 flex text-white relative overflow-hidden min-h-600 xl:min-h-full">
            <div className="hidden lg:block lg:w-1/2 xl:pr-45 pb-50 z-10">
              ...
              <p className="mt-40 font-light leading-tight">An NFT collection of 5000 Ethereum Clocks with enhancements
                available upto level 10. Penatibus egestas arcu eget eget ultrices eget et. Vitae, interdum nunc duis
                justo. Integer tincidunt feugiat sit diam.</p>
              <p className="mt-40 p-20 font-medium border-0 border-b border-gradient-light">500 Mints</p>
              <p className="mt-10 p-20 font-medium border-0 border-b border-gradient-light">Level 1-10 Enhancements
                available</p>
          ...
          <div onClick={() => goToNfts()}
               className="cursor-pointer absolute w-60 h-60 sm:w-100 sm:h-100 xl:w-120 xl:h-120 hidden lg:block lg:inset-x-2/3 lg:inset-y-1/2 -mr-200 z-30">
            <Image
